...
<div class="col-12">
  ...
  <form id="modif" action="#" method="POST">
    ...
    <input type="radio" class="custom-control-input" id="BLOQUE1" name="radio-stacked" value="1" checked>
    <label class="custom-control-label" for="BLOQUE1">Bloqué</label>
  </div>
  <div class="custom-control custom-radio mb-3">
    <input type="radio" class="custom-control-input" id="BLOQUE0" value="0" name="radio-stacked">
    <label class="custom-control-label" for="BLOQUE0">Non bloqué</label>
    <small id="Errblo" class="form-text text-danger invalid-feedback"><?php if (isset($ver['Errblo'])) echo $ver['Errblo']; ?></small>
  </div>

<?php  }else{  ?>
  <div class="custom-control custom-radio">
    <input type="radio" class="custom-control-input" id="BLOQUE1" value="1" name="radio-stacked">
    <label class="custom-control-label" for="BLOQUE1">Bloqué</label>
  </div>
  <div class="custom-control custom-radio mb-3">
    <input type="radio" class="custom-control-input" id="BLOQUE0" value="0" name="radio-stacked" checked>
    <label class="custom-control-label" for="BLOQUE0">Non bloqué</label>
    <small id="Errblo" class="form-text text-danger invalid-feedback"><?php if (isset($ver['Errblo'])) echo $ver['Errblo']; ?></small>
  </div>
